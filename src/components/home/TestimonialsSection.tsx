...
export const TestimonialsSection = ({
  ...
  return <section className="py-24 md:py-32 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div ref={testimonialsAnimation.ref} className={`transition-all duration-700 ${testimonialsAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {testimonials.length > 0 ? <Carousel opts={{
          align: "start",
          loop: true
        }} plugins={[Autoplay({
          delay: 4000
            ...
            </Carousel> : <div className="col-span-full text-center text-muted-foreground mb-12">
              Belum ada testimonial yang ditambahkan
            </div>}
        </div>
        <div className="text-center">
          <Button size="lg" variant="secondary" onClick={() => window.open(googleReviewUrl, "_blank")} className="gap-2">
